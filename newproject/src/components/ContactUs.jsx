...
const ContactUs = () => {
    return (
        <div className="mt-4 bg-dark text-white w-100">
            <h3 className="mb-4">Get in Touch</h3>
            <div className="d-flex flex-column align-items-start justify-content-start text-white-50">
                <p className="text-white-50">We are here to assist you. Reach out to us through any of the following channels:</p>
                <div className="d-flex align-items-center mb-4 justify-content-center">
                    <div className="d-flex align-items-center justify-content-center me-3" style={{ width: "25px", height: "25px", minWidth: "25px" }}>
                        <i className="bi bi-whatsapp fs-4 text-white-50 ms-3 mt-4"></i>
                    </div>
                ...
                <div className="d-flex align-items-center justify-content-center mb-4">
                    <div className="d-flex align-items-center justify-content-center me-3" style={{ width: "50px", height: "50px", minWidth: "50px" }}>
                        <i className="bi bi-envelope-fill fs-4 text-white-50 mt-4"></i>
                    </div>
                    <div className="text-break">
                ...
                <div className="d-flex align-items-center justify-content-center mb-4">
                    <div className="d-flex align-items-center justify-content-center me-3" style={{ width: "50px", height: "50px", minWidth: "50px" }}>
                        <i className="bi bi-telephone-fill fs-4 text-white-50 mt-4"></i>
                    </div>
                    <div className="text-break">
